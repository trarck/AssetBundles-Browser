...
namespace SocketAsyncServer
{
    class PrefixHandler
    {
        ...
        {            
            ...
            {
#if NET_DEBUG
                    Debug.Log("PrefixHandler, create prefix array " + receiveSendToken.TokenId);
#endif
            ...
            {
#if NET_DEBUG
                    Debug.Log("PrefixHandler, enough for prefix " + receiveSendToken.TokenId + ". remainingBytesToProcess = " + remainingBytesToProcess);
#endif
            ...
            {
#if NET_DEBUG
                    Debug.Log("PrefixHandler, NOT all of prefix " + receiveSendToken.TokenId + ". remainingBytesToProcess = " + remainingBytesToProcess);
#endif
